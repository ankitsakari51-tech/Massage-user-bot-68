...
import { Activity, ShieldCheck, Settings, Power, LogOut, Send, AlertTriangle, Users, History, MessageSquare, Save } from 'lucide-react';
  ...
  const saveMessageSettings = async () => {
    ...
    try {
      await fetch('/api/settings', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({ msgText, btnText, btnLink })
      });
    } catch (e) {
      console.error(e);
    }
      ...
      <div className="max-w-6xl mx-auto space-y-6">
        ...
        {!status?.isConnected && step !== 3 ? (
          <div className="bg-gray-900 border border-gray-800 rounded-xl p-6 max-w-md mx-auto mt-12">
            <h2 className="text-lg font-medium mb-4">Connect Account</h2>
              ...
              <div className="bg-gray-900 border border-gray-800 rounded-xl p-5">
                ...
                <div className="space-y-3">
                   ...
                   <div className="bg-gray-950 p-3 rounded-lg border border-gray-800">
                     ...
                     <div className="text-xl font-mono">{status?.messagesSentCurrentWindow || 0} / 5</div>
                   </div>
